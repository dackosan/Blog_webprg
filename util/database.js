...
db.prepare(`CREATE TABLE IF NOT EXISTS blogs (id INTEGER PRIMARY KEY AUTOINCREMENT, 
                                                userId INTEGER,
                                                title STRING,
                                                category STRING,
                                                content STRING,
                                                ...
                                                FOREIGN KEY(userId) REFERENCES users(id) ON DELETE CASCADE)`).run();
...
const modifyDateString = new Date().toISOString();
